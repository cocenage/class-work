...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tovar.index')->with('success', 'Ваш пост был добавлен');
    }
    ...
    {
        return view('tovar.edit', compact('product'));
    }
    ...
    {
        $product->delete();
        return redirect()->route('tovar.index')->with('success', 'Ваша запись была удалена');
    }
}
